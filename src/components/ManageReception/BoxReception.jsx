    ...
    <>
      <div className="flex flex-wrap justify-start items-start">
        ...
        <div className='w-full flex justify-around'>
           <Skeleton height={350} animation="wave w-1/4" />
           <Skeleton height={350} animation="wave w-1/4" />
           <Skeleton height={350} animation="wave w-1/4" />
        ...
        {statusCondition.length > 0 &&
          receptions
            ...
            .map((reception, i) => (
              <div className="px-2 lg:w-1/4 sm:w-1/2 w-full flex justify-center mt-3" key={i}>
                <CardReception
                  reception={reception}
      ...
      <DetailsPatient
        ...
        setPageStateReception={setPageStateReception}
        setHistoryReception={setHistoryReception}
        isLoading={isLoading}
        setPatient={setPatient}
