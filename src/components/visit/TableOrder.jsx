...
export default function TableOrder({ patSelected, setIsLoading, flag, setFlag , setIsOpenOrder , setOrderEdit , isLoading}) {
      ...
      <div>
        {listOrderSelected.length > 0 && (
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 550 }} aria-label="sticky table">
              <TableHead className="">
                <TableRow>
              ...
              <TableBody>
                {listOrderSelected.map((e) => (
                  <TableRow key={e.orderId}>
                    ...
                    sx={{backgroundColor:e.statusId===1?'rgb(234 179 8)':e.statusId===2?'rgb(59 130 246)':e.statusId===3?'rgb(34 197 94)':'rgb(239 68 68)' , color:'white' }}
                    ...
                    <TableCell align="center">
                      {
                        ...
                        <a target='_blank' rel="noreferrer" href={`${mainDomain}${e.resultSrc}`} download ><FaDownload /></a>
                        </div>
                      }
                    </TableCell>
                    <TableCell align="center">
        ...
        {listOrderSelected.length === 0 && !isLoading &&
        <div>
          <div className="flex justify-center">
