...
export default function ShowDocUploaded({ isShowfilePatient, setIsShowfilePatient, nationalId, appointmentId }) {
    ...
    if (appointmentId) {
      ...
      axios
        ...
        .then((res) => {
          ...
          // if (res.data.filter((e) => e.medicalItemId === 4).length > 0) {
          //   setSrc(res.data[0].attachmentSrc);
          // } else {
          //   Toast.fire({
          //     icon: 'error',
          //     text: 'مدارکی موجود نیست',
          //   });
          // }
        })
        .catch(() => {
  ...
  return (
    <>
      ...
      >
        ...
        {filesUpload.length === 0 && isLoadingFile && (
          <div>
