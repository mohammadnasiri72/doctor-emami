              ...
              <TableBody>
                {drugList.map((drug, i) => (
                  <TableRow key={drug.medicationId}>
                    <TableCell>
                      <span className="pr-2 font-semibold">{(currentPage - 1) * pageSize + i + 1}</span>
                    </TableCell>
                    <TableCell align="center">
                      <div className="flex flex-col text-xs">
                        ...
                        {drug.defaultNumber && (
                            <div className="px-1">
                              <Chip className="mt-2" label={`x ${drug.defaultNumber}`} />
                            </div>
                          )}
                          {drug.defaultDosage && (
                            <div className="px-1">
                    ...
                    <TableCell align="center">{drug.defaultNumber}</TableCell>
                    <TableCell align="center">
